...
public class BaseClassGrid {
	...
	public void setup(String brwName) throws IOException { // Loading Config.properties file
		...
		if (prop.getProperty("execution_env").equalsIgnoreCase("Remote")) {
			 ...
			 * capabilities.setPlatform(Platform.WIN11); } else
			 * if(OS.equalsIgnoreCase("Mac")) { capabilities.setPlatform(Platform.MAC); }
			 * else if(OS.equalsIgnoreCase("Linux")) {
			 * capabilities.setPlatform(Platform.LINUX); } else {
			 * System.out.println("No OS found!!"); return; }
			 */
			...
			driver = new RemoteWebDriver(new URL("http://192.168.0.169:4444/wd/hub"), capabilities);
		}
	...
	public String captureScreen(String screenShotName) throws IOException {
		...
		String tagetFilePath = System.getProperty("user.dir") + "\\screenshots\\" + screenShotName + "_" + timeStamp
				+ ".png";
